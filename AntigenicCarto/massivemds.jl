using RCall, ManifoldLearning, Plots, LinearAlgebra
...
# R"""
# rlocs <- locs
# hmc <- MassiveMDS::hmcsampler(n_iter=$nsamples +$burnin, data=dm, burnIn=$burnin, learnPrec=TRUE, learnTraitPrec=TRUE, gpu=1, treeCov=FALSE, trajectory=0.1, locations = rlocs)
# """
# @rget hmc 
