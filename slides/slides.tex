...
\begin{frame}{How to incorporate more data?}
    ...
    \begin{figure}
        \includegraphics[width=0.9\textwidth]{phylogeny.png}
    \end{figure}
\end{frame}
...
\begin{column}{\textwidth}
    \begin{figure}
        \includegraphics[width=0.8\textwidth]{gog_paper.png}
    \end{figure}
    \begin{figure}
        \includegraphics[width=0.8\textwidth]{gog_paper_2.png}
    \end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Infections provide cross-immunity to nearby strains}
        \centering
            \begin{figure}
                \includegraphics[width=0.6\textwidth]{gog_fig.png}
            \end{figure}
    \centering
    \vfill
