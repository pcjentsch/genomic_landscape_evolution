...
% SARS-CoV-2 neutralizing assays work similarly, except using dyes to assess antibody binding, but the principle is the same.
...
% Therefore, Lapedes and Farber came up with the used a modification of a technique called Multidimensional scaling, that given distances, produces a lower-dimensional manifold that minimizes the changes to the distances. 
...
\begin{frame}{Model Dynamics}
    \begin{figure} 
        \includegraphics[width=1.1\textwidth]{2022-07-12-01-05-21.png}
    \end{figure}
\end{frame}
