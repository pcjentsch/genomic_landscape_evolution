...
% ,  usually as proportional reduction in serum viral titre
    \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{columns}
        \begin{column}{0.5\textwidth}
            This technique was developed to visualize the antigenic drift of influenza A (H3N2)
        \end{column}
        \begin{column}{0.4\textwidth}
        \begin{figure}
...
\begin{frame}{Incorporating more data}
    \begin{itemize}
        ...
        \item Distance between any two samples is determined by the distance between the respective closest lineage in Wilks, plus the SNP distance, where each SNP is weighted by how often it recurs in the global tree
    \end{itemize}
\end{frame}
...
\begin{frame}
    \begin{figure}
        ...
        \caption{Map of all unique genomes collected in random USA sampling, considering the top 150 most recurrent SNPs}
    \end{figure}
\end{frame}
...
\begin{frame}
    I am working on fitting to data at the moment
\end{frame}
